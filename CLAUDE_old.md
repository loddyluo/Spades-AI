...
python rl/pretrain_rl_multicpu.py --num-games 20000 --seed 42 --lr 0.0005  --num-workers 32 --update-interval 120 --num-epochs 1 --entropy-coef 0.25 --save-interval 5000
tensorboard --logdir runs/rl_train --port 6011
tensorboard --logdir runs/pretrain_rl_16models --port 6011
...
目前可用的两条评测命令：
python rl/eval_rl_multicpu.py --num-games 1500 --seed 601 --num-workers 30 --load-checkpoint ./p0601.pt

python /root/Spades-AI/evaluate/eval_rule_first4_multicpu.py --num-games 1500 --seed 601 --num-workers 30

接着训练：
python rl/pretrain_rl_multicpu.py --num-games 500000 --seed 42 --lr 0.0001 --num-workers 32 --update-interval 300 --num-epochs 1 --entropy-coef 0.05 --load-checkpoint ./p0601.pt

【16模型训练】
 python rl/pretrain_rl_multicpu.py --num-games 40000 --seed 6010000 --lr 0.001 --num-workers 32 --update-interval 512 --num-epochs 1 --entropy-coef 0.10

评测：
python rl/eval_rl_multicpu.py --num-games 10000 --seed 61 --num-workers 30 --load-checkpoint ./rl_checkpoints/pretrain_16models

python evaluate/eval_rule_first4_multicpu.py --num-games 1500 --seed 6100000 --num-workers 30

第二把
python rl/pretrain_rl_multicpu.py --num-games 80000 --seed 601 --lr 0.0005 --num-workers 32 --update-interval 512 --num-epochs 1 --entropy-coef 0.10

异步训练
python rl/async.py --num-games-per-stage 20000 --seed 42 --lr 0.001 --num-workers 32 --update-interval 128 --num-epochs 1 --entropy-coef 0.10
