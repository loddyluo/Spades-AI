...
class ExactDoubleDummyCppOpt1Solver(ExactDoubleDummySolver):
    """原生 C++ 搜索内核优化尝试版（opt1）。"""
    ...
    def _ensure_library(self) -> None:
        ...
        src = os.path.join(this_dir, "exact_double_dummy_cpp_opt1_core.cpp")
        out = os.path.join(this_dir, "_exact_double_dummy_cpp_opt1_core.so")
