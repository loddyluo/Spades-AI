# 检查得分计算函数是否正确，确认一队的总墩数是两个人叫起来的墩数的和
...
def create_two_trick_state():
    ...
    target_strs = ["SA", "SK", "SQ", "H2", "H3", "H4", "H5", "H6", "H8", "H9", "HT", "HJ"]
    target_cards = []
    ...
    # 分配手牌：每玩家2张
    hands = [
        [target_cards[0], target_cards[3], target_cards[4]],  # P0: SA,H2,H3
        [target_cards[1], target_cards[5], target_cards[6]],  # P1: SK,H4,H5
        [target_cards[2], target_cards[8], target_cards[9]],  # P2: SQ,H8,H9
        [target_cards[7], target_cards[10], target_cards[11]],  # P3: ♠Q, ♥4
    ]
    ...
    state.bids = [
        ...
        Bid(player_id=3, value='bid_3'),  # 02队：-100分，13队：-60分
    ]
    state.max_bid = ['nil', 'bid_3', 'nil', 'bid_3']
