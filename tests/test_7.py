...
def create_two_trick_state():
    ...
    # 分配手牌：每玩家2张
    hands = [
        [target_cards[0], target_cards[1], target_cards[2]],  # P0: ♠A, ♥5
        [target_cards[3], target_cards[4], target_cards[5]],  # P1: ♥2, ♥3
        [target_cards[6], target_cards[7], target_cards[8]],  # P2: ♠K, ♣A
        [target_cards[9], target_cards[10], target_cards[11]],  # P3: ♠Q, ♥4
    ]
    ...
    state.bids = [
        ...
        Bid(player_id=3, value='bid_3'),  # 02队：30分，13队：-60分
    ]
    state.max_bid = ['bid_2', 'bid_3', 'bid_1', 'bid_3']
