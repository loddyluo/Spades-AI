...
def create_two_trick_state():
    ...
    hands = [
        [target_cards[0], target_cards[1], target_cards[5]],  # P0: SA, SK, C4
        [target_cards[2], target_cards[6], target_cards[3]],  # P1: SQ, C5, H2
        [target_cards[11], target_cards[8], target_cards[9]],  # P2: H9, HT, HJ
        [target_cards[7], target_cards[10], target_cards[4]],  # P3: H3, H8, H6
    ]
    ...
    state.bids = [
        ...
        Bid(player_id=3, value='nil'), # 02队：-30,13队：0 或 02队：30,13队：100
    ]
    state.max_bid = ['bid_2', 'nil', 'bid_1', 'nil']
...
def main():
    ...
    print("\n使用MCTS求解器...")
    solver = DoubleDummySolver(max_iterations=10000)
