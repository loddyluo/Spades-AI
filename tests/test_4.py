...
def create_two_trick_state():
    ...
    # 分配手牌：每玩家2张
    hands = [
        [target_cards[0], target_cards[5]],  # P0: ♠A, ♥5
        [target_cards[2], target_cards[3]],  # P1: ♥2, ♥3
        [target_cards[6], target_cards[7]],  # P2: ♠K, ♣A
        [target_cards[1], target_cards[4]],  # P3: ♠Q, ♥4
    ]
    ...
    state.bids = [
        ...
        Bid(player_id=3, value='bid_4'),  # 02队：20分，13队：-80分
    ]
    state.max_bid = ['bid_1', 'bid_4', 'bid_1', 'bid_4']
