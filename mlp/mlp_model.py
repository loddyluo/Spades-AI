...
class DoubleDummyMLP(nn.Module):
    """Dual-head MLP for value prediction and policy logits.

    Used as an optional prior/value oracle in TruncatedMCTSStrategy.
    """
    ...
    def forward(self, x: torch.Tensor | np.ndarray) -> dict[str, torch.Tensor]:
        ...
        return {"value": value, "policy_logits": policy_logits}
